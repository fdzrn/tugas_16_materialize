	...
	render(){
		return(
			<Row>
         	...
         	Audio Technica - mulai dari <mark style={{backgroundColor:"red"}}>Rp. 910K</mark>
         	</Card>
         </Col>
				<Col l={3} m={6} s={12}>
					...
					Handphone Samsung - mulai dari <mark style={{backgroundColor:"red"}}>Rp. 200K</mark>
					</Card>
				</Col>
				<Col l={3} m={6} s={12}>
					...
					Squishy - mulai dari <mark style={{backgroundColor:"red"}}>Rp. 55K</mark>
					</Card>
				</Col>
				<Col l={3} m={6} s={12}>
					...
					Action Figure - mulai dari <mark style={{backgroundColor:"red"}}>Rp. 100k</mark>
					</Card>
				</Col>
			</Row>
		);
